...
<body class="pagina-painel"><header><h1>FoodToGo</h1><nav><a href="index.html">Home</a><a href="restaurantes.php">Restaurantes</a><span class="nav-utilizador">Admin: <?= h($_SESSION['nome']) ?></span><a href="scripts/logout.php" class="nav-destaque">Sair</a></nav></header>
