...
$stmt = $db->prepare('SELECT id FROM utilizadores WHERE username = :username OR email = :email');
...
$stmt = $db->prepare("INSERT INTO utilizadores (nome, username, email, password, tipo, ultimo_acesso) VALUES (:nome, :username, :email, :password, 'cliente', NULL)");
